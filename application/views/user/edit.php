...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        <h1 class="mt-5"><b>Editar los datos del usuario: </b><?php echo $full_name; ?> </h1>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="fullName" class="form-control mt-2 <?php echo form_error('fullName') ? 'is-invalid':'' ;?>" placeholder="Nombre completo" value="<?php echo $full_name; ?>">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="email" class="form-control mt-2 <?php echo form_error('email') ? 'is-invalid':'' ;?>" aria-describedby="emailHelp" placeholder="Correo eléctronico" value="<?php echo $email; ?>">
                        <div class="invalid-feedback">
